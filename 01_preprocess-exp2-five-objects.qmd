---
title: "Import and preprocessing. Experiment 2: five game objects."
format: html
---
...
```{r}
results <- read_csv("Data/exp2-five-objects/five-objects-2022-09-21.csv",
  ...
  separate(round_objects, into=sprintf("RoundObject%d", c(1:2)), sep = " ") |>
  separate(round_colors, into=sprintf("RoundColor%d", c(1:2)), sep = " ") |>
...
saveRDS(results, file = "Data/exp2-five-objects/exp2.RDS")
```
...
saveRDS(data_for_stan, file = "Data/exp2-five-objects/exp2-standata.RDS")
```
