---
title: "Analysis. Experiment 3: nine game objects."
format: html
---
...
loo_files <- fs::dir_ls("Loos/exp3-nine-objects", type = "file", glob = "*loo_exp3_*.RDS")
model_names <- 
  loo_files |>
  fs::path_file() |>
  fs::path_ext_remove() |>
  stringr::str_remove("loo_exp3_")
...
draws_filename <- glue::glue("Draws/exp3-nine-objects/draws_exp3_{selected_model}.RDS")
...
model <- cmdstan_model(glue::glue("Stan/exp3-nine-objects/{selected_model}.stan"))
...
```{r}
#|eval: false
log_lik <- purrr::map(model_names, ~readRDS(glue("LogLik/exp3-nine-objects/loglik_exp3_{.}.RDS")), progress = TRUE)
...
```{r}
results <- 
  readRDS("Data/exp3-nine-objects/exp3.RDS") |>
...
Group averages
```{r}
if (fs::file_exists("Averages/object-and-set-exp3-posterior.RDS")) {
  avg_prediction_object_and_set_per_group <- readRDS("Averages/object-and-set-exp3-posterior.RDS")
} else {
  ...
  saveRDS(avg_prediction_object_and_set_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/object-and-set-exp3-posterior.RDS")
}

if (fs::file_exists("Averages/object-and-set-exp3-bootstrap.RDS")) {
  avg_bootstrap_object_and_set_per_group <- readRDS("Averages/object-and-set-exp3-bootstrap.RDS")
} else {
  avg_bootstrap_object_and_set_per_group <- sample_average_repetition("Object", object_and_set_repetition_filter, "group", R=Rsample)
  saveRDS(avg_bootstrap_object_and_set_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/object-and-set-exp3-bootstrap.RDS")
}
...
```{r}
if (fs::file_exists("Loos/exp3-nine-objects/loo_object_and_set.RDS")) {
  loo_object_and_set <- readRDS("Loos/exp3-nine-objects/loo_object_and_set.RDS")
} else {
  loo_object_and_set <- loo_using_filter(results, log_lik, object_and_set_repetition_filter)
  saveRDS(loo_object_and_set, "Loos/exp3-nine-objects/loo_object_and_set.RDS")
}

if (fs::file_exists("Loos/exp3-nine-objects/loo_object_and_set_table.RDS")) {
  loo_object_and_set_table <- readRDS("Loos/exp3-nine-objects/loo_object_and_set_table.RDS")  
} else {
  loo_object_and_set_table <- compute_loo_summary_df(loo_object_and_set)
  saveRDS(loo_object_and_set_table, "Loos/exp3-nine-objects/loo_object_and_set_table.RDS")
}
...
Group averages
```{r}
if (fs::file_exists("Averages/object-not-set-exp3-posterior.RDS")) {
  avg_prediction_object_not_set_per_group <- readRDS("Averages/object-not-set-exp3-posterior.RDS")  
} else {
  ...
  saveRDS(avg_prediction_object_not_set_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/object-not-set-exp3-posterior.RDS")
}

if (fs::file_exists("Averages/object-not-set-exp3-bootstrap.RDS")) {
  avg_bootstrap_object_not_set_per_group <- readRDS("Averages/object-not-set-exp3-bootstrap.RDS")
} else {
  avg_bootstrap_object_not_set_per_group <- sample_average_repetition("Object", object_not_set_repetition_filter, "group", R=Rsample)
  saveRDS(avg_bootstrap_object_not_set_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/object-not-set-exp3-bootstrap.RDS")
}
...
```{r}
if (fs::file_exists("Loos/exp3-nine-objects/loo_object_and_set.RDS")) {
  loo_object_not_set <- readRDS("Loos/exp3-nine-objects/loo_object_and_set.RDS")  
} else {
  loo_object_not_set <- loo_using_filter(results, log_lik, object_not_set_repetition_filter)
  saveRDS(loo_object_not_set, "Loos/exp3-nine-objects/loo_object_and_set.RDS")
}
  
if (fs::file_exists("Loos/exp3-nine-objects/loo_object_and_set_table.RDS")) {
  loo_object_not_set_table <- readRDS("Loos/exp3-nine-objects/loo_object_and_set_table.RDS")
} else {
  loo_object_not_set_table <- compute_loo_summary_df(loo_object_not_set)
  saveRDS(loo_object_not_set_table, "Loos/exp3-nine-objects/loo_object_and_set_table.RDS")
}
...
Group averages
```{r}
if (fs::file_exists("Averages/set-not-object-exp3-posterior.RDS")) {
  avg_prediction_set_not_object_per_group <- readRDS("Averages/set-not-object-exp3-posterior.RDS")
} else {
  ...
  saveRDS(avg_prediction_set_not_object_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/set-not-object-exp3-posterior.RDS")
}
  
if (fs::file_exists("Averages/set-not-object-exp3-bootstrap.RDS")) {
  avg_bootstrap_set_not_object_per_group <- readRDS("Averages/set-not-object-exp3-bootstrap.RDS")  
} else {
  avg_bootstrap_set_not_object_per_group <- sample_average_repetition("Set", set_not_object_repetition_filter, "group", R=Rsample)
  saveRDS(avg_bootstrap_set_not_object_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/set-not-object-exp3-bootstrap.RDS")
}
...
```{r}
if (fs::file_exists("Loos/exp3-nine-objects/loo_set_not_object.RDS")) {
  loo_set_not_object <- readRDS("Loos/exp3-nine-objects/loo_set_not_object.RDS")
} else {
  loo_set_not_object <- loo_using_filter(results, log_lik, set_not_object_repetition_filter)
  saveRDS(loo_set_not_object, "Loos/exp3-nine-objects/loo_set_not_object.RDS")
}

if (fs::file_exists("Loos/exp3-nine-objects/loo_set_not_object_table.RDS")) {
  loo_set_not_object_table <- readRDS("Loos/exp3-nine-objects/loo_set_not_object_table.RDS")
} else {
  loo_set_not_object_table <- compute_loo_summary_df(loo_set_not_object)
  saveRDS(loo_set_not_object_table, "Loos/exp3-nine-objects/loo_set_not_object_table.RDS")
}
...
Group averages
```{r}
if (fs::file_exists("Averages/color-and-set-not-object-exp3-posterior.RDS")) {
  avg_prediction_color_and_set_not_object_per_group <- readRDS("Averages/color-and-set-not-object-exp3-posterior.RDS")
} else {
  ...
  saveRDS(avg_prediction_color_and_set_not_object_per_group |> add_column(Experiment = "Experiment 3"),
          "Averages/color-and-set-not-object-exp3-posterior.RDS")
}

if (fs::file_exists("Averages/color-and-set-not-object-exp3-bootstrap.RDS")) {
  avg_bootstrap_color_and_set_not_object_per_group <- readRDS("Averages/color-and-set-not-object-exp3-bootstrap.RDS")
} else {
  ...
  saveRDS(avg_bootstrap_color_and_set_not_object_per_group  |> add_column(Experiment = "Experiment 3"),
          "Averages/color-and-set-not-object-exp3-bootstrap.RDS")
}
...
```{r}
if (fs::file_exists("Loos/exp3-nine-objects/loo_color_and_set_not_object.RDS")) {
  loo_color_and_set_not_object <- readRDS("Loos/exp3-nine-objects/loo_color_and_set_not_object.RDS")
} else {
  loo_color_and_set_not_object <- loo_using_filter(results, log_lik, color_and_set_not_object_repetition_filter)
  saveRDS(loo_color_and_set_not_object, "Loos/exp3-nine-objects/loo_color_and_set_not_object.RDS")
}

if (fs::file_exists("Loos/exp3-nine-objects/loo_color_and_set_not_object_table.RDS")) {
  loo_color_and_set_not_object_table <- readRDS("Loos/exp3-nine-objects/loo_color_and_set_not_object_table.RDS")
} else {
  loo_color_and_set_not_object_table <- compute_loo_summary_df(loo_color_and_set_not_object)
  saveRDS(loo_color_and_set_not_object_table, "Loos/exp3-nine-objects/loo_color_and_set_not_object_table.RDS")
}
