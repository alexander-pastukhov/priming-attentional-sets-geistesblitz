...
for(im in 1:length(model_names)) {
  cat(model_names[im], "\n")
  loo_filename <- fs::path("Loos/exp2-five-objects", glue("loo_exp2_{model_names[im]}.RDS"))
  loglik_filename <- fs::path("LogLik/exp2-five-objects", glue("loglik_exp2_{model_names[im]}.RDS"))
  draws_filename <- fs::path("Draws/exp2-five-objects", glue("draws_exp2_{model_names[im]}.RDS")) 
