...
parameters {
  ...
  // relative obj, set, and color salience change
...
transformed parameters {
...

  {
    ...
    vector[ColorsN] color_memory;
    vector[ColorsN] color_salience;
    ...
    for (irow in 1:N){
      ...
      for(iColor in 1:ColorsN) color_memory[iColor] += obj_set_color_delta[3, participant[irow]] * (is_target_color[irow, iColor] - color_memory[iColor]);
