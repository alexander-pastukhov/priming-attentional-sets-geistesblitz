...
transformed parameters {
...

  {
    ...
    for (irow in 1:N){
      ...
      for (iObj in 1:ObjN) obj_salience[trial_attention_set[irow], iObj] += obj_set_color_delta[1, participant[irow]] * (is_target[irow, iObj] - obj_salience[trial_attention_set[irow], iObj]);
