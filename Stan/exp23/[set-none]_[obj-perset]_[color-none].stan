...
transformed parameters {
...

  {
    ...
    for (irow in 1:N){
      ...
      if (trial[irow] == 1) obj_salience = rep_matrix(1.0 / ObjN, SetsN, ObjN);
      ...
      for (iObj in 1:ObjN) {
        obj_salience[trial_attention_set[irow], iObj] += obj_delta[participant[irow]] * (is_target[irow, iObj] - obj_salience[trial_attention_set[irow], iObj]);
      }
    }
  }
}
