...
transformed parameters {
...

  {
    ...
    for (irow in 1:N){
      ...
      for (iObj in 1:ObjN) obj_memory[trial_attention_set[irow], iObj] += obj_color_delta[1, participant[irow]] * (is_target[irow, iObj] - obj_memory[trial_attention_set[irow], iObj]);
