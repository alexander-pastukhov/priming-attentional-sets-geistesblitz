// Attention sets : fixed common penalty for identifying the set
...
transformed parameters {
...

  {
    ...
    for (irow in 1:N){
      ...
      // compute logMu using target salience
      ...
      for (iObj in 1:ObjN) obj_memory[trial_attention_set[irow], iObj] += obj_delta[participant[irow]] * (is_target[irow, iObj] - obj_memory[trial_attention_set[irow], iObj]);
    }
  }
}
